...
The Lixent project has strict rules for AI usage:
...
These rules apply only to outside contributions to Lixent. Maintainers
...
Please remember that Lixent is maintained by humans.
